...
public class HazyColorArm extends SubsystemBase {
    ...
    HazyColorSensor s_ColorSensor = new HazyColorSensor();
    ...
    public void setInitColor(){
        ...
        initColor = s_ColorSensor.getColor();
